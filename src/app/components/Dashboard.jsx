 ...
 export default function Dashboard() {
  return (
    <div className=" shadow rounded-lg h-40   w-70 bg-[('/imgg.png')] ">
 ...
 text-sm space-y-1">
        <li className="mb-6 pl-10">Add your first &lt;code&gt;</li>
        <li className="mb-6 text-[rgb(40,159,192,1)] pl-10">Create a program</li>
